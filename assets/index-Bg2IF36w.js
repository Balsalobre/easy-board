...
`;const s=document.getElementById("fontSize"),d=document.getElementById("fontWeight"),l=document.getElementById("chalkColor"),a=document.getElementById("board"),p=document.getElementById("date-display");function u(){const o=new Date,n={weekday:"long",year:"numeric",month:"long",day:"numeric"},r=o.toLocaleDateString("es-ES",n),i=r.charAt(0).toUpperCase()+r.slice(1);p.textContent=i}u();setInterval(()=>{const o=new Date;o.getHours()===0&&o.getMinutes()===1&&u()},6e4);s.addEventListener("change",()=>{a.style.fontSize=s.value});d.addEventListener("change",()=>{a.style.fontWeight=d.value});l.addEventListener("change",()=>{a.style.color=l.value;const o=l.value.replace("0.9","0.6"),n=l.value.replace("0.9","0.3");a.style.textShadow=`0 0 2px ${o}, 0 0 4px ${n}`});
